...
public class SampleTabsDefault extends BaseSampleActivity {
    private static final String[] CONTENT = new String[] { "Profile", "Monthly", "Partners", "Countries", "Products" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TradeProfilesAdapter(getSupportFragmentManager());
    ...
    class TradeProfilesAdapter extends TestFragmentAdapter {
        public TradeProfilesAdapter(FragmentManager fm) {
            super(fm);
        }
